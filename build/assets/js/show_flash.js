...
(function (window, document, $, undefined) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    bag.attach(window.FlashMessage.success('Message bag #1'), window.FlashMessage.info('Message bag #2', { progress: true }), window.FlashMessage.error('Message bag #3'));

    document.getElementById('flash-btn').addEventListener('click', function () {
      new window.FlashMessage(this.dataset.message, this.dataset.type, {
