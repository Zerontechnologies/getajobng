...
module.exports = {
    ...
    "test_server_host": "getajobng.herokuapp.com",
    "test_server_username": "rentacar_gaj_usr",
    "test_server_password": "%Getaj0b1",
    "test_server_database": "rentacar_getajobng",
    ...
    //"from"                    :     '"Jobs from GetaJobNG" <info@getajobng.com>',
    "from": "info@getajobng.com",
    ...
    // File Upload Setting
    "resume_upload_dir": _path2.default.join(__dirname, "../assets/uploads/docs/resumes/"),
    "additional_resume_upload_dir": _path2.default.join(__dirname, "../assets/uploads/docs/other_resumes/"),
    "profile_picture_upload_dir": _path2.default.join(__dirname, "../assets/uploads/images/profile_pictures/"),
    "profile_picture_dir": "/uploads/images/profile_pictures/",
    "company_logo_upload_dir": _path2.default.join(__dirname, "../assets/uploads/images/company_logos/"),
    "company_logo_dir": "/uploads/images/company_logos/",
    "main_assets_resume_dir": _path2.default.join(__dirname, "../../assets/uploads/docs/resumes/"),
    "main_assets_additional_resume_dir": _path2.default.join(__dirname, "../../assets/uploads/docs/other_resumes/"),
    "main_assets_profile_pic_dir": _path2.default.join(__dirname, "../../assets/uploads/images/profile_pictures/")
